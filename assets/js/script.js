...
let blogName = "Lex's Social Software Blog";
let authorName = "Lex";
let authorLink = "/lex.decker/about/"; // Enter your website, social media, etc. Some way for people to tell you they like your blog! (Leaving it empty is okay too)
...
let postsArray = [
  ...
  ["posts/2023-11-14-projects-in-permacomputing.html"],
...
let headerHTML = '<ul> <li><a href="/lex.decker/">home</a></li>' +
  '<li><a href="/lex.decker/about/">about</a></li>' +
  '<li><a href="/lex.decker/now/">now</a></li></ul>';
...
let footerHTML = "<hr><p>" + blogName + " is written by <a href='" + authorLink + "'>" + authorName + "</a>, built with <a href='https://zonelets.net/'>Zonelets</a>, and hosted by <a href='https://purchase.edu/'>Purchase!</a></p>";
...
if (postsArray.length > recentPostsCutoff) {
  recentPostListHTML += '<li class="moreposts"><a href=/lex.decker/archive/>\u00BB more posts</a></li></ul>';
} else {
